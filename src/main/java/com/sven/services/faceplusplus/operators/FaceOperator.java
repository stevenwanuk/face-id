...
public class FaceOperator extends ApiOperator {
     ...
     * @throws Exception
     */
    public FaceAttachUserIdResponse faceSetUserId(final String faceToken, final UserId userId) throws Exception {
        ...
        builder.queryParam(Key.KEY_FOR_USER_ID, JsonUtils.toBase64(userId));
