...
public class FaceSetOperator1 {
	...
	//
	//
	// public FaceSetOperator1(final String apiKey, final String apiSecret, final
	// String baseUrl, final RestTemplate restTemplate){
	// this.apiKey = apiKey;
	...
	// * Add face_token into an existing FaceSet. One FaceSet can hold up to 1000
	// face_token.
	// * @param faceTokens 人脸标识face_token组成的字符串，可以是一个或者多个，用逗号分隔。最多不超过5个face_token
	// * One or more face_token, comma-seperated. The number of face_token must not
	// be larger than 5.
	...
	// * @throws Exception
	// */
	// public Response addFaceByFaceToken(final String faceTokens, final String
	// faceSetToken) throws Exception {
	...
	// * @throws Exception
	// */
	// public Response addFaceByOuterId(final String FaceTokens, final String
	// outerId) throws Exception {
	// String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT
	// + Constants.ADDFACE;
	// HashMap<String, String> map = new HashMap<>();
	// map.put(Constants.KEY_FOR_APIKEY, apiKey);
	...
	// }
	//
	// public FaceSetCreateResponse createFaceSet(final String displayName, final
	// String outerId, final String tags, final String FaceTokens, final String
	// userData, final int ForceMerge){
	// String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT
	// + Constants.CREATE;
	//
	...
	// * Create a face collection called FaceSet to store face_token. One FaceSet
	// can hold up to 1000 face_token
	// * @param displayName 人脸集合的名字，256个字符，不能包括字符^@,&=*'"
	// * The name of FaceSet. No more than 256 characters, and must not contain
	// characters ^@,&=*'"
	// * @param outerId 账号下全局唯一的FaceSet自定义标识，可以用来管理FaceSet对象。最长255个字符，不能包括字符^@,&=*'"
	// * Custom unique id of Faceset under your account, used for managing FaceSet
	// objects.
	...
	// * Custom user information. No larger than 16KB, and must not contain
	// characters ^@,&=*'"
	// * @param ForceMerge
	...
	// * 默认值为0
	// * Determine whether or not add face_token into existing FaceSet, if outer_id
	// is passed and outer_id already exists.
	// * 0: face_tokens will not be added into existing FaceSet, and return
	// FACESET_EXIST error message instead.
	// * 1: add face_tokens into existing FaceSet.
	// * The default value is 0.
	// * @return
	// * @throws Exception
	// */
	// public Response createFaceSet1(final String displayName, final String
	// outerId, final String tags, final String FaceTokens, final String userData,
	...
	// * If the value is 1, when the FaceSet contains face_token, it cannot be
	// deleted.
	// * @return
	// * @throws Exception
	// */
	// public Response deleteFaceSetByToken(final String faceSetToken, final int
	// checkEmpty) throws Exception {
	// String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT
	// + Constants.DELETE;
	// HashMap<String, String> map = new HashMap<>();
	// map.put(Constants.KEY_FOR_APIKEY, apiKey);
	...
	// * @throws Exception
	// */
	// public Response deleteFaceSetByOuterId(final String outerId, final int
	// checkEmpty) throws Exception {
	// String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT
	// + Constants.DELETE;
	// HashMap<String, String> map = new HashMap<>();
	...
	// * @throws Exception
	// */
	// public Response getDetailByFaceToken(final String faceSetToken) throws
	// Exception {
	// String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT
	...
	// * The face_token to be removed, comma-seperated. The number of face_token
	// must not be larger than 1000.
	// * Note: if this string passed "RemoveAllFaceTokens", all the face_token
	// within FaceSet will be removed.
	// * @return
	// * @throws Exception
	// */
	// public Response removeFaceFromFaceSetByFaceSetToken(final String
	// faceSetToken, final String faceTokens) throws Exception {
	// String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT
	...
	// * @throws Exception
	// */
	// public Response removeFaceFromFaceSetByOuterId(final String outerId, final
	// String faceTokens) throws Exception {
	// String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT
	// + Constants.REMOVE_FACE;
	// HashMap<String, String> map = new HashMap<>();
	// map.put(Constants.KEY_FOR_APIKEY, apiKey);
	...
	// * @throws Exception
	// */
	// public Response updateFaceSetByFaceSetToken(final String faceSetToken, final
	// String newOuterId, final String displayName, final String userData, final
	...
	// * @throws Exception
	// */
	// public Response updateFaceSetByOuterId(final String outerId, final String
	// newOuterId, final String displayName, final String userData, final String
