...
import com.sven.services.faceplusplus.HttpRequest;
import com.sven.services.faceplusplus.Response;
import com.sven.services.faceplusplus.model.FaceSetCreateResponse;
import com.sven.utils.Constants;

public class FaceSetOperator1 {
    ...
    public FaceSetOperator1(final String apiKey, final String apiSecret, final String baseUrl, final RestTemplate restTemplate){
        this.apiKey = apiKey;
     ...
     * @throws Exception
     */
    public Response addFaceByFaceToken(final String faceTokens, final String faceSetToken) throws Exception {
        String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT + Constants.ADDFACE;
    ...
    public FaceSetCreateResponse createFaceSet(final String displayName, final String outerId, final String tags, final String FaceTokens, final String userData, final int ForceMerge){
        String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT + Constants.CREATE;
        ...
        builder.queryParam(Constants.KEY_FOR_FORCE_MERGE, String.valueOf(ForceMerge));
        
        HttpEntity<FaceSetCreateResponse> response =  restTemplate.exchange(url,  HttpMethod.POST, null, FaceSetCreateResponse.class);
     ...
     * @throws Exception
     */
    public Response createFaceSet1(final String displayName, final String outerId, final String tags, final String FaceTokens, final String userData, final int ForceMerge) throws Exception {
        String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT + Constants.CREATE;
        HashMap<String, String> map = new HashMap<>();
        map.put(Constants.KEY_FOR_APIKEY, apiKey);
        map.put(Constants.KEY_FOR_APISECRET, apiSecret);
        ...
        map.put(Constants.KEY_FOR_FORCE_MERGE, String.valueOf(ForceMerge));
        return HttpRequest.post(url, map, null);
    }
     ...
     * @throws Exception
     */
    public Response deleteFaceSetByToken(final String faceSetToken, final int checkEmpty) throws Exception {
        String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT + Constants.DELETE;
        HashMap<String, String> map = new HashMap<>();
        map.put(Constants.KEY_FOR_APIKEY, apiKey);
        map.put(Constants.KEY_FOR_APISECRET, apiSecret);
        map.put(Constants.KEY_FOR_FACESET_TOKEN, faceSetToken);
     ...
     * @throws Exception
     */
    public Response deleteFaceSetByOuterId(final String outerId, final int checkEmpty) throws Exception {
        String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT + Constants.DELETE;
        HashMap<String, String> map = new HashMap<>();
        map.put(Constants.KEY_FOR_APIKEY, apiKey);
        map.put(Constants.KEY_FOR_APISECRET, apiSecret);
    ...
    public Response getDetailByFaceToken(final String faceSetToken) throws Exception {
        String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT + Constants.GET_DETAIL;
        HashMap<String, String> map = new HashMap<>();
        map.put(Constants.KEY_FOR_APIKEY, apiKey);
        map.put(Constants.KEY_FOR_APISECRET, apiSecret);
        map.put(Constants.KEY_FOR_FACESET_TOKEN, faceSetToken);
     ...
     * @throws Exception
     */
    public Response removeFaceFromFaceSetByFaceSetToken(final String faceSetToken, final String faceTokens) throws Exception {
        String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT + Constants.REMOVE_FACE;
        HashMap<String, String> map = new HashMap<>();
        map.put(Constants.KEY_FOR_APIKEY, apiKey);
        map.put(Constants.KEY_FOR_APISECRET, apiSecret);
        map.put(Constants.KEY_FOR_FACESET_TOKEN, faceSetToken);
     ...
     * @throws Exception
     */
    public Response removeFaceFromFaceSetByOuterId(final String outerId, final String faceTokens) throws Exception {
        String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT + Constants.REMOVE_FACE;
        HashMap<String, String> map = new HashMap<>();
        map.put(Constants.KEY_FOR_APIKEY, apiKey);
        map.put(Constants.KEY_FOR_APISECRET, apiSecret);
    ...
    public Response getFaceSets(final String tags) throws Exception {
        String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT + Constants.GET_FACESETS;
        HashMap<String, String> map = new HashMap<>();
        map.put(Constants.KEY_FOR_APIKEY, apiKey);
        map.put(Constants.KEY_FOR_APISECRET, apiSecret);
        map.put(Constants.KEY_FOR_TAGS, tags);
     ...
     * @throws Exception
     */
    public Response updateFaceSetByFaceSetToken(final String faceSetToken, final String newOuterId, final String displayName, final String userData, final String tags) throws Exception {
        String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT + Constants.UPDATE;
        HashMap<String, String> map = new HashMap<>();
        map.put(Constants.KEY_FOR_APIKEY, apiKey);
        map.put(Constants.KEY_FOR_APISECRET, apiSecret);
        map.put(Constants.KEY_FOR_FACESET_TOKEN, faceSetToken);
     ...
     * @throws Exception
     */
    public Response updateFaceSetByOuterId(final String outerId, final String newOuterId, final String displayName, final String userData, final String tags) throws Exception {
        String url = baseUrl + Constants.SPLIT + Constants.FACESET + Constants.SPLIT + Constants.UPDATE;
        HashMap<String, String> map = new HashMap<>();
        map.put(Constants.KEY_FOR_APIKEY, apiKey);
        map.put(Constants.KEY_FOR_APISECRET, apiSecret);
