...
public class FaceSetController
{
    ...
    {
        Response response =
                service.createFaceSet(displayName, outerId, tags, FaceTokens, userData,
                        ForceMerge);
    ...
    @PutMapping("/face")
    public String addFaceByOuterId(@RequestParam final String FaceTokens,
            @RequestParam final String outerId) throws Exception
    {
