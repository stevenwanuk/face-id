...
public class FaceSetController {
	...
	public String create(@RequestParam final String displayName, @RequestParam final String outerId,
			@RequestParam final String tags, @RequestParam(required = false, defaultValue = "") final String FaceTokens,
			@RequestParam(required = false, defaultValue = "") final String userData,
			@RequestParam(required = false, defaultValue = "0") final int ForceMerge) throws Exception {
		Response response = service.createFaceSet(displayName, outerId, tags, FaceTokens, userData, ForceMerge);
	...
	public String deleteFaceSetByOuterId(@RequestParam final String outerId) throws Exception {
